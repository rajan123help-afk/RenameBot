...
OWNER_ID = 123456789 # Apni ID yahan dalein
...
async def tmdb_search(c, m):
    if len(m.command) < 2: return await m.reply_text("Usage: /search Name")
...
async def engine(c, m):
    ...
    # 2. IMAGE IDENTIFICATION (Screenshot Fix)
    ...
    # 3. URL UPLOADER (Auto-Delete status)
